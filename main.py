...
async def scan_place_with_ai(image: UploadFile = File(...)):
    ...
    system_instruction = (
        "أنت مساعد ذكي لمدينة رام الله. استخرج البيانات من صورة كرت المحل أو المنيو. "
        "أعد النتيجة بتنسيق JSON يحتوي على الحقول: name, category, phone, area, description, "
        "whatsapp, instagram, facebook. الحقول غير الموجودة اتركها فارغة."
    )
