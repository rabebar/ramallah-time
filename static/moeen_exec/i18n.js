(() => {
  ...
  const english = {
    ...
    "تحدث الآن": "Speak Now",
    "خدمة من مُعين": "A Service by Moeen",
    "اِحكيها": "Ahkiha",
    "كلامك يصبح نصًا مرتبًا وجاهزًا.": "Turn Your Speech into Clear, Ready-to-Use Text.",
    "تحدّث بالعربية، راجع النص، ثم احفظه في مكانه المناسب داخل مُعين أو شاركه مباشرةً مع من تريد.": "Speak, review the text, then save it in the right place in Moeen or share it directly.",
    "تحويل فوري": "Instant Transcription",
    "ترتيب تلقائي": "Smart Organization",
    "حفظ أو مشاركة": "Save or Share",
    "ابدأ «احكيها»": "Start Ahkiha",
    "تنويه من مُعين": "A Note from Moeen",
    "محتواك الشخصي مشفّر قبل المزامنة ولا يظهر في لوحة الإدارة. ويمكنك استخدام مُعين على الهاتف والكمبيوتر بعد ربط الجهاز الآخر من مركز الأمان. وإذا عرفت شخصًا قد يستفيد منه، يمكنك": "Your personal content is encrypted before syncing and is not visible in the administration dashboard. You can use Moeen on mobile and desktop after pairing the other device from the Security Center. If you know someone who may benefit from it, you can",
    "مشاركة رابط التسجيل": "share the registration link",
    "مشاركة النص": "Share Text",
    "الوقت المتبقي": "Time Remaining",
    "الحد الأقصى دقيقتان": "Two-Minute Limit",
    "يمكنك التسجيل فقط، أو استخدام الإملاء لتحويل العربية إلى نص لمدة تصل إلى دقيقتين.": "You can record audio or use dictation for up to two minutes.",
    "تبقّت 10 ثوانٍ وسيتم الإيقاف تلقائيًا مع الاحتفاظ بما تم تسجيله.": "10 seconds remaining. Capture will stop automatically and keep what was recorded.",
    "أوقف الإملاء المباشر أولًا قبل بدء التسجيل الصوتي.": "Stop live dictation before starting an audio recording.",
    "أوقف التسجيل الصوتي أولًا قبل بدء الإملاء المباشر.": "Stop the audio recording before starting live dictation.",
    "التسجيل جارٍ… الحد الأقصى دقيقتان.": "Recording… Two-minute limit.",
    "حدث انقطاع قصير في التسجيل، ويحاول مُعين المتابعة تلقائيًا…": "The recording was briefly interrupted. Moeen is resuming it automatically…",
    "تمت متابعة التسجيل تلقائيًا بعد انقطاع قصير…": "Recording resumed automatically after a brief interruption…",
    "الإملاء مستمر… تمت استعادة الاستماع تلقائيًا.": "Dictation is continuing… Listening resumed automatically.",
    "تعذر استمرار الإملاء. تحقق من إذن الميكروفون والاتصال ثم حاول مجددًا.": "Dictation could not continue. Check microphone permission and your connection, then try again.",
    "اكتملت مدة الدقيقتين وتوقف الإملاء تلقائيًا. راجع النص ثم احفظه أو شاركه.": "The two-minute limit was reached and dictation stopped automatically. Review the text, then save or share it.",
    "أتحدث الآن… سيظهر النص أثناء كلامك، والحد الأقصى دقيقتان.": "Listening… Text will appear as you speak. The limit is two minutes.",
    ...
    "طريقة ربط جهاز آخر ←": "How to Pair Another Device →",
    "رشّح مُعين لمن يحتاجه": "Recommend Moeen",
    "شارك رابط إنشاء الحساب ليبدأ زميلك تجربته المجانية ويُنظّم مواعيده وملاحظاته ومتابعاته.": "Share the registration link so a colleague can start a free trial and organize appointments, notes, and follow-ups.",
    "مشاركة رابط التسجيل ←": "Share Registration Link →",
    ...
    "الإشعارات غير مفعّلة على هذا الجهاز.": "Notifications are not enabled on this device.",
    "الإشعارات محظورة من إعدادات الجهاز. اسمح بها من إعدادات الموقع.": "Notifications are blocked in device settings. Allow them in the site settings.",
    "الإشعارات محظورة": "Notifications Blocked",
    "يحتاج هذا الجهاز إلى إعادة ربط الإشعارات.": "This device needs its notifications reconnected.",
    "إعادة تفعيل الإشعارات": "Reconnect Notifications",
    "الإشعارات مفعّلة ومتصلة بهذا الحساب.": "Notifications are enabled and connected to this account.",
    "جارٍ إرسال إشعار تجريبي…": "Sending a test notification…",
    "تم إرسال الإشعار التجريبي. يفترض أن يظهر خلال لحظات.": "The test notification was sent and should appear shortly.",
    "لم يعد اشتراك هذا الجهاز صالحًا. أعد تفعيل الإشعارات.": "This device notification subscription is no longer valid. Reconnect notifications.",
    "تعذر إرسال الإشعار التجريبي الآن.": "The test notification could not be sent right now.",
    ...
    "فهمت الموعد التالي": "I Understood This Event",
    "راجعه قبل الحفظ، ويمكنك تعديله.": "Review or edit it before saving.",
    "حدد موعد الحدث": "Set the Event Time",
    "لم يُذكر موعد واضح؛ أدخله يدويًا قبل الحفظ.": "No clear time was mentioned. Enter it before saving.",
    "موعد": "Event",
    "تم التعرف على اتصال يحتاج إلى تذكير.": "A call requiring a reminder was detected.",
    "راجع التاريخ والوقت قبل الحفظ.": "Review the date and time before saving.",
    "الموعد غير صحيح": "Invalid Event Time",
    "حدد التاريخ والوقت الصحيحين قبل الحفظ.": "Set a valid date and time before saving.",
    "الموعد مطلوب": "Event Time Required",
    "اختر موعدًا لاحقًا؛ لا يمكن تفعيل إشعار لموعد منتهٍ.": "Choose a future time; a reminder cannot be enabled for an expired event.",
    "الموعد مضى": "Event Time Has Passed",
    "تم تأكيد الموعد": "Event Confirmed",
  ...
  const patterns = [
    ...
    [/^تم حفظ الموعد:\s*(.+)$/u, "Event saved: $1"],
