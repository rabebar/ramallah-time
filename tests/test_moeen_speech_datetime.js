...
const cases = [
  ...
  ["\u0645\u0648\u0639\u062f \u0628\u0639\u062f \u062b\u0644\u0627\u062b\u0647 \u0627\u064a\u0627\u0645", date => Math.abs((date - now) / 86400000 - 3) < 0.01],
  ["\u0645\u0648\u0639\u062f \u0628\u0639\u062f \u0633\u0628\u0639 \u0623\u064a\u0627\u0645", date => Math.abs((date - now) / 86400000 - 7) < 0.01],
  ["\u0645\u0648\u0639\u062f \u0628\u0639\u062f \u0623\u0633\u0628\u0648\u0639", date => Math.abs((date - now) / 86400000 - 7) < 0.01],
  ["\u0645\u0648\u0639\u062f \u0628\u0639\u062f \u0627\u0633\u0628\u0648\u0639\u064a\u0646", date => Math.abs((date - now) / 86400000 - 14) < 0.01],
  ["\u0645\u0648\u0639\u062f \u0628\u0639\u062f \u062b\u0644\u0627\u062b\u0629 \u0627\u0633\u0627\u0628\u064a\u0639", date => Math.abs((date - now) / 86400000 - 21) < 0.01],
  ["\u0627\u062c\u062a\u0645\u0627\u0639 \u0627\u0644\u064a\u0648\u0645 \u0627\u0644\u0633\u0627\u0639\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u0639\u0634\u0631\u0629", date => date.getHours() === 12],
];

const durationVariants = [
  ["بعد يوم", 1], ["بعد يومين", 2], ["بعد يومان", 2],
  ["بعد اربعه يوم", 4], ["بعد أربعة أيام", 4], ["بعد اربعه ايام", 4], ["بعد أربع تيام", 4],
  ["بعد أسبوع", 7], ["بعد اسبوع", 7], ["بعد أسبوعين", 14], ["بعد اسبوعين", 14],
  ["بعد أسبوعان", 14], ["بعد اسبوعان", 14], ["بعد ثلاث أسابيع", 21], ["بعد ثلاث اسابيع", 21],
];
for (const [phrase, days] of durationVariants) {
  cases.push([phrase, date => Math.abs((date - now) / 86400000 - days) < 0.01]);
}
